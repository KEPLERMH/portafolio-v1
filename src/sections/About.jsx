...
const About = () => {
  return (
    <section
      id="about"
      className="bg-slate-900 text-secondarytext px-8 pt-16 pb-12 grid gap-9 xl:px-36"
    >
      ...
      <article className="grid gap-8 md:grid-cols-2 md:gap-16">
        ...
        <div className="flex flex-col gap-8">
          <p className="text-lg">
            Desarrollador web con conocimientos en HTML, CSS, JavaScript react y
            Node.js. Enfocado en crear aplicaciones funcionales y mejorar
            constantemente mis habilidades en desarrollo full stack.
          </p>
          <p className="text-sm text-trirdtext">
            Mi enfoque se centra en escribir código mantenible, diseñar
            experiencias de usuario excepcionales y mantenerme actualizado con
            las últimas tendencias tecnológicas. Creo en el aprendizaje continuo
